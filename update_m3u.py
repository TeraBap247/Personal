...
ignore_names = {
    name.lower() for name in [
        ...
        "disney xd", "mr bean", "cartoon network english", "cartoon network hd", "nick hd plus", "cn-pak", "psl vip",
        ...
        "zee zest hd", "tlc hd", "travelxp hd hindi", "discovery channel bengali", "discovery science",
        "discovery turbo", "animal planet hd world", "discovery", "star plus", "jalsha movies hd", "star jalsha hd",
        "sun bangla", "colors bangla", "zee bangla hd", "super hungama tv", "rongeen tv", "sonic bangla",
        ...
        "sony yay bangla", "gubbare tv", "disney hindi", "nick bangla", "cartoon network hindi", "pogo hindi", "bein sports", "sony aath", "sony sab", "zee cinema", "sony max",
